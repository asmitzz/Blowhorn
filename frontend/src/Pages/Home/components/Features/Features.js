...
const Features = () => {
  const features = [
    ...
    {
      icon: <span class="iconify" data-icon="ion:notifications-outline" style={{color: "white",fontSize:"1.5rem"}}></span>,
      name: "NOTIFICATIONS",
      content:
        "Send out notifications to all your customers to keep them engaged.",
    },
    {
      icon: <span class="iconify" data-icon="akar-icons:shipping-box-v1" style={{color: "white",fontSize:"1.5rem"}}></span>,
      name: "BUNDLES",
      content: "High quality bundles of awesome tools to help you out.",
    },
    {
      icon: <span class="iconify" data-icon="ic:baseline-developer-mode" style={{color: "white",fontSize:"1.5rem"}}></span>,
      name: "DEVELOPER TOOLKIT",
      content:
        "Developer tools to help grow your application and keep it up-to-date.",
    },
    {
      icon: <span class="iconify" data-icon="cil:library-building" style={{color: "white",fontSize:"1.5rem"}}></span>,
      name: "BUILDING BLOCKS",
      content:
        "The right kind of building blocks to take your company to the next level.",
    },
    {
      icon: <span class="iconify" data-icon="bx:bxs-coupon" style={{color: "white",fontSize:"1.5rem"}} data-rotate="180deg"></span>,
      name: "COUPONS",
      content:
